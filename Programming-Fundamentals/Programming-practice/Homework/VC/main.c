...
FECHA capture_date(char *, int, int, int);
void capture_numeric_digits(char *, int *, int, int, int);
void capture_numeric_decimals(char *, int *, int, int, int);
...
int main() {
   ...
   do {
      ...
      if (selected_option == ALPHANUM_CAPTURE) {
         ...
         fecha_result = capture_date(field_buffer, 10, menu_x + 25, menu_y + 2);
         ...
         capture_numeric_digits(digits_buffer, &digits_before_decimal, 2, menu_x + 25, menu_y + 3);

         char decimals_buffer[80] = {0};
         gotoxy(10, 9);
         printf("Digitos despues del punto:");
         capture_numeric_decimals(decimals_buffer, &digits_after_decimal, 2, menu_x + 25, menu_y + 5);
...
*/
FECHA capture_date(char *date_str, int field_length, int pos_x, int pos_y) {
   int cursor_index = 0;
   char pressed_key;
   FECHA result_date;
...
*/
void capture_numeric_digits(char *digit_str, int *result_value, int max_digits, int pos_x, int pos_y) {
   int cursor_index = 0;
   char pressed_key;
...
Retorno: void
*/
void capture_numeric_decimals(char *decimal_str, int *result_value, int max_digits, int pos_x, int pos_y) {
   capture_numeric_digits(decimal_str, result_value, max_digits, pos_x, pos_y);
}
