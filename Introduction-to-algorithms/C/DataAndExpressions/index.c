...
void ABC_Arithmetic_operations(int a, int b, int c)
{
  ...
  char *StringData =
      "Suponga que a, b y c son variables enteras que tienen los valores 8, 3, "
      "y -5, respectivamente. Determine el valor de cada una de las siguientes "
...
{
  // Next stage point 2
  char *StringData_point2 =
      "Suponga que x, y y z son variables flotantes que tienen los valores "
      "8.8, 3.5, y -5.2, respectivamente. Determine el valor de cada una de "
      "las siguientes expresiones aritmeticas.";
